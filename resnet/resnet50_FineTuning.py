...
#----------------------------------------------------
model = load_model('resnet50_finetuning.h5')
...
with open('hist_resnet50_fine_tuning.pickle', 'wb') as handle:
...
#------------------------------------------------------------
for i in range(8):
    namepath = 'resnet50_finetuning/output_0/' + str(i) + '.png'
...
for i in range(n):
    ...
    for j in range(m):
        namepath = 'resnet50_finetuning/output_1/' + str(i) + '_'+ str(j) + '.png'
        matplotlib.image.imsave(namepath, intermediate_output1[i,:,:,j])

#--------------------------------------------------------------------------
layer_name2 = 'activation_1'
...
for i in range(n):
    ...
    for j in range(m):
        namepath = 'resnet50_finetuning/output_2/' + str(i) + '_'+ str(j) + '.png'
        matplotlib.image.imsave(namepath, intermediate_output2[i,:,:,j])

#--------------------------------------------------------------------------
layer_name3 = 'max_pooling2d_1'
...
for i in range(n):
    ...
    for j in range(m):
        namepath = 'resnet50_finetuning/output_3/' + str(i) + '_'+ str(j) + '.png'
        matplotlib.image.imsave(namepath, intermediate_output3[i,:,:,j])

#------------------------------------------------------------------------
layer_name4 = 'activation_2'
...
for i in range(n):
    ...
    for j in range(m):
        namepath = 'resnet50_finetuning/output_4/' + str(i) + '_'+ str(j) + '.png'
        matplotlib.image.imsave(namepath, intermediate_output4[i,:,:,j])

#---------------------------------------------------------------------
layer_name5 = 'activation_3'
...
for i in range(n):
    ...
    for j in range(m):
        namepath = 'resnet50_finetuning/output_5/' + str(i) + '_'+ str(j) + '.png'
