...
model = load_model('vgg16_finetuning.h5')
#-----------------------------------------
...
#------------------------------------------------------------
with open('hist_vgg16_fine_tuning.pickle', 'wb') as handle:
...
for i in range(n):
    ...
    for j in range(m):
        namepath = 'vgg16_output_1/' + str(i) + '_'+ str(j) + '.png'
        matplotlib.image.imsave(namepath, intermediate_output1[i,:,:,j])

#-----------------------------------------------------
layer_name2 = 'block2_conv2'
...
for i in range(n):
    ...
    for j in range(m):
        namepath = 'vgg16_output_2/' + str(i) + '_'+ str(j) + '.png'
        matplotlib.image.imsave(namepath, intermediate_output2[i,:,:,j])

#----------------------------------
layer_name3 = 'block3_conv3'
...
for i in range(n):
    ...
    for j in range(m):
        namepath = 'vgg16_output_3/' + str(i) + '_'+ str(j) + '.png'
        matplotlib.image.imsave(namepath, intermediate_output3[i,:,:,j])


layer_name4 = 'block4_conv3'
...
for i in range(n):
    ...
    for j in range(m):
        namepath = 'vgg16_output_4/' + str(i) + '_'+ str(j) + '.png'
